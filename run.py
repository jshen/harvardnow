...
box = [
    ...
    {'service': 'L', 'roomid':'1362520', 'machinetype':'dryer', 'label': 'DUNSTER HOUSE K Dryers', 'tags': ['DUNSTER', 'HOUSE', 'K', 'LAUNDRY', 'DRYER', 'DRYERS']},
    {'service': 'L', 'roomid':'1362521', 'machinetype':'washer', 'label': 'DUNSTER HOUSE G Washers', 'tags': ['DUNSTER', 'HOUSE', 'G', 'LAUNDRY', 'WASHERS', 'WASHER']},
    {'service': 'L', 'roomid':'1362521', 'machinetype':'dryer', 'label': 'DUNSTER HOUSE G Dryers', 'tags': ['DUNSTER', 'HOUSE', 'G', 'LAUNDRY', 'DRYER', 'DRYERS']},
    {'service': 'L', 'roomid':'144633', 'machinetype':'washer', 'label': '10 DEWOLFE STREET Washers', 'tags': ['10', 'DEWOLFE', 'STREET', 'LAUNDRY', 'WASHERS', 'WASHER']},
    {'service': 'L', 'roomid':'144633', 'machinetype':'dryer', 'label': '10 DEWOLFE STREET Dryers', 'tags': ['10', 'DEWOLFE', 'STREET', 'LAUNDRY', 'DRYER', 'DRYERS']},
    {'service': 'L', 'roomid':'1362589', 'machinetype':'washer', 'label': 'STOUGHTON HALL Washers', 'tags': ['STOUGHTON', 'HALL', 'LAUNDRY', 'WASHERS', 'WASHER']},
    {'service': 'L', 'roomid':'1362589', 'machinetype':'dryer', 'label': 'STOUGHTON HALL Dryers', 'tags': ['STOUGHTON', 'HALL', 'LAUNDRY', 'DRYER', 'DRYERS']},
    ...
    {'service': 'L', 'roomid':'1362540', 'machinetype':'dryer', 'label': 'CABOT HOUSE - BRIGGS HALL Dryers', 'tags': ['CABOT', 'HOUSE', '-', 'BRIGGS', 'HALL', 'LAUNDRY', 'DRYER', 'DRYERS']},
    ...
    {'service': 'L', 'roomid':'1362515', 'machinetype':'dryer', 'label': '1202 MASS AVE 4TH FLR LR Dryers', 'tags': ['1202', 'MASS', 'AVE', '4TH', 'FLR', 'LR', 'LAUNDRY', 'DRYER', 'DRYERS']},
    ...
    {'service': 'L', 'roomid':'1362513', 'machinetype':'washer', 'label': 'PFORZHEIMER HOUSE - COMSTOCK HALL Washers', 'tags': ['PFORZHEIMER','PFOHO', 'POOH', 'HOUSE', '-', 'COMSTOCK', 'HALL', 'LAUNDRY', 'WASHERS', 'WASHER']},
    {'service': 'L', 'roomid':'1362513', 'machinetype':'dryer', 'label': 'PFORZHEIMER HOUSE - COMSTOCK HALL Dryers', 'tags': ['PFORZHEIMER','PFOHO', 'POOH','HOUSE', '-', 'COMSTOCK', 'HALL', 'LAUNDRY', 'DRYER', 'DRYERS']},
    {'service': 'L', 'roomid':'1362541', 'machinetype':'washer', 'label': 'HURLBUT HALL Washers', 'tags': ['HURLBUT', 'HURL', 'PENNYPACKER', 'PENNY', 'HALL', 'LAUNDRY', 'WASHERS', 'WASHER']},
    {'service': 'L', 'roomid':'1362541', 'machinetype':'dryer', 'label': 'HURLBUT HALL Dryers', 'tags': ['HURLBUT', 'HURL', 'PENNYPACKER', 'PENNY', 'HALL', 'LAUNDRY', 'DRYER', 'DRYERS']},
    ...
    {'service': 'L', 'roomid':'1362514', 'machinetype':'washer', 'label': 'PFORZHEIMER HOUSE - MOORS HALL Washers', 'tags': ['PFORZHEIMER','PFOHO', 'POOH','HOUSE', '-', 'MOORS', 'HALL', 'LAUNDRY', 'WASHERS', 'WASHER']},
    {'service': 'L', 'roomid':'1362514', 'machinetype':'dryer', 'label': 'PFORZHEIMER HOUSE - MOORS HALL Dryers', 'tags': ['PFORZHEIMER','PFOHO','POOH', 'HOUSE', '-', 'MOORS', 'HALL', 'LAUNDRY', 'DRYER', 'DRYERS']},
    {'service': 'L', 'roomid':'1362549', 'machinetype':'washer', 'label': 'PFORZHEIMER HOUSE - HOLMES HALL Washers', 'tags': ['PFORZHEIMER','PFOHO', 'POOH','HOUSE', '-', 'HOLMES', 'HALL', 'LAUNDRY', 'WASHERS', 'WASHER']},
    {'service': 'L', 'roomid':'1362549', 'machinetype':'dryer', 'label': 'PFORZHEIMER HOUSE - HOLMES HALL Dryers', 'tags': ['PFORZHEIMER','PFOHO', 'POOH','HOUSE', '-', 'HOLMES', 'HALL', 'LAUNDRY', 'DRYER', 'DRYERS']},
    {'service': 'L', 'roomid':'1362557', 'machinetype':'washer', 'label': 'PFORZHEIMER HOUSE - JORDAN SOUTH Washers', 'tags': ['PFORZHEIMER','PFOHO', 'POOH','HOUSE', '-', 'JORDAN', 'SOUTH', 'LAUNDRY', 'WASHERS', 'WASHER']},
    {'service': 'L', 'roomid':'1362557', 'machinetype':'dryer', 'label': 'PFORZHEIMER HOUSE - JORDAN SOUTH Dryers', 'tags': ['PFORZHEIMER','PFOHO','POOH', 'HOUSE', '-', 'JORDAN', 'SOUTH', 'LAUNDRY', 'DRYER', 'DRYERS']},
    ...
    {'service': 'L', 'roomid':'1362546', 'machinetype':'dryer', 'label': 'ADAMS HOUSE Dryers', 'tags': ['ADAMS', 'HOUSE', 'LAUNDRY', 'DRYER', 'DRYERS']},
    {'service': 'L', 'roomid':'1362528', 'machinetype':'washer', 'label': 'LOWELL HOUSE G  Washers', 'tags': ['LOWELL', 'HOUSE', 'G', '', 'LAUNDRY', 'WASHERS', 'WASHER']},
    {'service': 'L', 'roomid':'1362528', 'machinetype':'dryer', 'label': 'LOWELL HOUSE G  Dryers', 'tags': ['LOWELL', 'HOUSE', 'G', '', 'LAUNDRY', 'DRYER', 'DRYERS']},
    ...
    {'service': 'L', 'roomid':'1362515', 'machinetype':'dryer', 'label': '1201 MASS AVE 3RD FLR LR Dryers', 'tags': ['1201', 'MASS', 'AVE', '3RD', 'FLR', 'LR', 'LAUNDRY', 'DRYER', 'DRYERS']},
    {'service': 'L', 'roomid':'1362514', 'machinetype':'washer', 'label': '24 PRESCOTT ST Washers', 'tags': ['24', 'PRESCOTT', 'ST', 'LAUNDRY', 'WASHERS', 'WASHER']},
    {'service': 'L', 'roomid':'1362514', 'machinetype':'dryer', 'label': '24 PRESCOTT ST Dryers', 'tags': ['24', 'PRESCOTT', 'ST', 'LAUNDRY', 'DRYER', 'DRYERS']},
    {'service': 'L', 'roomid':'014711', 'machinetype':'washer', 'label': '8 PLYMPTON STREET Washers', 'tags': ['8', 'PLYMPTON', 'STREET', 'LAUNDRY', 'WASHERS', 'WASHER']},
    {'service': 'L', 'roomid':'014711', 'machinetype':'dryer', 'label': '8 PLYMPTON STREET Dryers', 'tags': ['8', 'PLYMPTON', 'STREET', 'LAUNDRY', 'DRYER', 'DRYERS']},
    ...
    {'service': 'L', 'roomid':'1362527', 'machinetype':'dryer', 'label': 'LEVERETT HOUSE G TOWER Dryers', 'tags': ['LEVERETT', 'HOUSE', 'G', 'TOWER', 'LAUNDRY', 'DRYER', 'DRYERS']},
    {'service': 'L', 'roomid':'1362588', 'machinetype':'washer', 'label': 'THAYER HALL Washers', 'tags': ['THAYER', 'HALL', 'LAUNDRY', 'WASHERS', 'WASHER']},
    {'service': 'L', 'roomid':'1362588', 'machinetype':'dryer', 'label': 'THAYER HALL Dryers', 'tags': ['THAYER', 'HALL', 'LAUNDRY', 'DRYER', 'DRYERS']},
    ...
    {'service': 'L', 'roomid':'1362537', 'machinetype':'dryer', 'label': 'CABOT HOUSE - ELLIOT HALL Dryers', 'tags': ['CABOT', 'HOUSE', '-', 'ELLIOT', 'HALL', 'LAUNDRY', 'DRYER', 'DRYERS']},
    {'service': 'L', 'roomid':'1362547', 'machinetype':'washer', 'label': 'APLEY COURT Washers', 'tags': ['APLEY', 'APPLY', 'COURT', 'LAUNDRY', 'WASHERS', 'WASHER']},
    {'service': 'L', 'roomid':'1362547', 'machinetype':'dryer', 'label': 'APLEY COURT Dryers', 'tags': ['APLEY', 'APPLY', 'COURT', 'LAUNDRY', 'DRYER', 'DRYERS']},
    ...
    {'service': 'L', 'roomid':'144634', 'machinetype':'dryer', 'label': '20 DEWOLFE STREET Dryers', 'tags': ['20', 'DEWOLFE', 'STREET', 'LAUNDRY', 'DRYER', 'DRYERS']},
    ...
    {'service': 'L', 'roomid':'1362526', 'machinetype':'dryer', 'label': 'LEVERETT HOUSE F TOWER Dryers', 'tags': ['LEVERETT', 'HOUSE', 'F', 'TOWER', 'LAUNDRY', 'DRYER', 'DRYERS']},
    {'service': 'L', 'roomid':'1362523', 'machinetype':'washer', 'label': 'ELIOT HOUSE J Washers', 'tags': ['ELIOT','ELLIOT', 'HOUSE', 'J', 'LAUNDRY', 'WASHERS', 'WASHER']},
    {'service': 'L', 'roomid':'1362523', 'machinetype':'dryer', 'label': 'ELIOT HOUSE J Dryers', 'tags': ['ELIOT', 'ELLIOT', 'HOUSE', 'J', 'LAUNDRY', 'DRYER', 'DRYERS']},
    {'service': 'L', 'roomid':'1362584', 'machinetype':'washer', 'label': 'CANADAY HALL Washers', 'tags': ['CANADAY', 'CANDY', 'HALL', 'LAUNDRY', 'WASHERS', 'WASHER']},
    {'service': 'L', 'roomid':'1362584', 'machinetype':'dryer', 'label': 'CANADAY HALL Dryers', 'tags': ['CANADAY','CANDY', 'HALL', 'LAUNDRY', 'DRYER', 'DRYERS']},
    {'service': 'L', 'roomid':'1362539', 'machinetype':'washer', 'label': 'PFORZHEIMER HOUSE - JORDAN NORTH Washers', 'tags': ['PFORZHEIMER','PFOHO', 'POOH', 'HOUSE', '-', 'JORDAN', 'NORTH', 'LAUNDRY', 'WASHERS', 'WASHER']},
    {'service': 'L', 'roomid':'1362539', 'machinetype':'dryer', 'label': 'PFORZHEIMER HOUSE - JORDAN NORTH Dryers', 'tags': ['PFORZHEIMER','PFOHO','POOH', 'HOUSE', '-', 'JORDAN', 'NORTH', 'LAUNDRY', 'DRYER', 'DRYERS']},
    ...
    {'service': 'L', 'roomid':'1362511', 'machinetype':'dryer', 'label': 'CABOT HOUSE - BERTRAM HALL Dryers', 'tags': ['CABOT', 'HOUSE', '-', 'BERTRAM', 'HALL', 'LAUNDRY', 'DRYER', 'DRYERS']},
    ...
    {'service': 'L', 'roomid':'1362516', 'machinetype':'dryer', 'label': 'GREENOUGH HALL Dryers', 'tags': ['GREENOUGH', 'HALL', 'LAUNDRY', 'DRYER', 'DRYERS']},
    {'service': 'L', 'roomid':'1362555', 'machinetype':'washer', 'label': 'CLAVERLY HALL Washers', 'tags': ['CLAVERLY', 'HALL', 'LAUNDRY', 'WASHERS', 'WASHER']},
    {'service': 'L', 'roomid':'1362555', 'machinetype':'dryer', 'label': 'CLAVERLY HALL Dryers', 'tags': ['CLAVERLY', 'HALL', 'LAUNDRY', 'DRYER', 'DRYERS']},
    ...
    {'service': 'L', 'roomid':'1362532', 'machinetype':'dryer', 'label': 'NEW QUINCY BASEMENT STUDENT LAUNDRY Dryers', 'tags': ['NEW', 'QUINCY', 'BASEMENT', 'STUDENT', 'LAUNDRY', 'LAUNDRY', 'DRYER', 'DRYERS']},
    ...
    {'service': 'L', 'roomid':'1362534', 'machinetype':'dryer', 'label': '65 MOUNT AUBURN STREET Dryers', 'tags': ['65', 'MOUNT', 'AUBURN', 'STREET', 'LAUNDRY', 'DRYER', 'DRYERS']},
    {'service': 'L', 'roomid':'1362536', 'machinetype':'washer', 'label': 'WINTHROP - GORE Washers', 'tags': ['WINTHROP', '-', 'GORE', 'LAUNDRY', 'WASHERS', 'WASHER']},
    {'service': 'L', 'roomid':'1362536', 'machinetype':'dryer', 'label': 'WINTHROP - GORE Dryers', 'tags': ['WINTHROP', '-', 'GORE', 'LAUNDRY', 'DRYER', 'DRYERS']},
    ...
    {'service': 'L', 'roomid':'1362548', 'machinetype':'dryer', 'label': 'MATHER HOUSE HIGH RISE Dryers', 'tags': ['MATHER', 'HOUSE', 'HIGH', 'RISE', 'LAUNDRY', 'DRYER', 'DRYERS']},
    ...
    {'service': 'L', 'roomid':'1362512', 'machinetype':'dryer', 'label': 'CABOT HOUSE - WHITMAN HALL Dryers', 'tags': ['CABOT', 'HOUSE', '-', 'WHITMAN', 'HALL', 'LAUNDRY', 'DRYER', 'DRYERS']},
    ...
    {'service': 'L', 'roomid':'1362556', 'machinetype':'dryer', 'label': 'MATHER HOUSE LOW RISE Dryers', 'tags': ['MATHER', 'HOUSE', 'LOW', 'RISE', 'LAUNDRY', 'DRYER', 'DRYERS']},
    ...
    {'service': 'S-S', 'stopid': '4190632' , 'label': 'Maxwell Dworkin Shuttle Stop', 'tags':['MAXWELL', 'DWORKIN', 'MD', 'SHUTTLE', 'STOP']},
...
e.g. Widener Gate    Quad Yard Express
