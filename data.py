...
box = [
    ...
    {'service': 'MBTA', 'args': {'pg': ['green/lake']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'BOSTON', 'COLLEGE', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/sougr']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'SOUTH', 'ST', 'STREET', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/chill']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'CHESTNUT', 'AVE', 'GREEN', 'HILL']},
    {'service': 'MBTA', 'args': {'pg': ['green/chswk']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'RD', 'CHISWICK', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/sthld']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'RD', 'SUTHERLAND', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/wascm']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'WASHINGTON', 'ST', 'STREET', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/wrnst']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'ST', 'WARREN', 'STREET', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/alsgr']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'ALLSTON', 'ST', 'STREET', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/grigg']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'STREET', 'ST', 'GRIGGS', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/harvd']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'HARVARD', 'AVE', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/brico']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'PACKARDS', 'GREEN', 'CORNER']},
    {'service': 'MBTA', 'args': {'pg': ['green/babck']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'BABCOCK', 'ST', 'STREET', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/plsgr']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'STREET', 'ST', 'PLEASANT', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/stplb']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'STREET', 'PAUL', 'ST', 'ST.', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/buwst']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'BU', 'WEST', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/bucen']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'BU', 'GREEN', 'CENTRAL']},
    {'service': 'MBTA', 'args': {'pg': ['green/buest']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'BU', 'EAST', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/bland']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'BLANDFORD', 'ST', 'STREET', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/kencl']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'KENMORE', 'GREEN']},
    ...
    {'service': 'MBTA', 'args': {'pg': ['green/armnl']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'ARLINGTON', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/boyls']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'BOYLSTON', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/pktrm']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'PARK', 'ST', 'STREET', 'GREEN']},
    ...
    {'service': 'MBTA', 'args': {'pg': ['green/denrd']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'RD', 'DEAN', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/tapst']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'ST', 'TAPPAN', 'STREET', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/bcnwa']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'SQUARE', 'SQ', 'WASHINGTON', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/fbkst']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'FAIRBANKS', 'ST', 'STREET', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/bndhl']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'BRANDON', 'HALL', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/sumav']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'SUMMIT', 'AVE', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/cool']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'CORNER', 'COOLIDGE', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/stpul']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'STREET', 'PAUL', 'ST', 'ST.', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/kntst']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'ST', 'STREET', 'GREEN', 'KENT']},
    {'service': 'MBTA', 'args': {'pg': ['green/hwsst']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'HAWES', 'ST', 'STREET', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/smary']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'STREET', 'MARYS', 'ST', 'ST.', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/kencl']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'KENMORE', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/hymnl']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'HYNES', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/coecl']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'COPLEY', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/armnl']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'ARLINGTON', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/boyls']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'BOYLSTON', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/pktrm']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'PARK', 'ST', 'STREET', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/gover']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'CENTER', 'GOVERNMENT', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/haecl']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'HAYMARKET', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/north']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'STATION', 'GREEN', 'NORTH']},
    ...
    {'service': 'MBTA', 'args': {'pg': ['green/waban']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'WABAN', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/eliot']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'ELIOT', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/newtn']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'HIGHLANDS', 'GREEN', 'NEWTON']},
    {'service': 'MBTA', 'args': {'pg': ['green/newto']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'CENTRE', 'GREEN', 'NEWTON']},
    {'service': 'MBTA', 'args': {'pg': ['green/chhil']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'CHESTNUT', 'GREEN', 'HILL']},
    {'service': 'MBTA', 'args': {'pg': ['green/rsmnl']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'RESERVOIR', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/bcnfd']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'BEACONSFIELD', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/brkhl']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'HILLS', 'GREEN', 'BROOKLINE']},
    {'service': 'MBTA', 'args': {'pg': ['green/bvmnl']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'VILLAGE', 'GREEN', 'BROOKLINE']},
    ...
    {'service': 'MBTA', 'args': {'pg': ['green/boyls']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'BOYLSTON', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/pktrm']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'PARK', 'ST', 'STREET', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/hsmnl']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'HEATH', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/bckhl']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'OF', 'BACK', 'THE', 'GREEN', 'HILL']},
    {'service': 'MBTA', 'args': {'pg': ['green/rvrwy']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'RIVERWAY', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/mispk']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'PARK', 'GREEN', 'MISSION']},
    {'service': 'MBTA', 'args': {'pg': ['green/fenwd']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'RD', 'GREEN', 'FENWOOD']},
    {'service': 'MBTA', 'args': {'pg': ['green/brmnl']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'CIRCLE', 'GREEN', 'BRIGHAM']},
    {'service': 'MBTA', 'args': {'pg': ['green/lngmd']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'MEDICAL', 'AREA', 'GREEN', 'LONGWOOD']},
    {'service': 'MBTA', 'args': {'pg': ['green/mfa']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'OF', 'FINE', 'ARTS', 'GREEN', 'MUSEUM']},
    ...
    {'service': 'MBTA', 'args': {'pg': ['green/haecl']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'HAYMARKET', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/north']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'STATION', 'GREEN', 'NORTH']},
    {'service': 'MBTA', 'args': {'pg': ['green/spmnl']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'END', 'WEST', 'PARK', 'SCIENCE', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/lech']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'LECHMERE', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['red/RALE']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'ALEWIFE', 'RED']},
    {'service': 'MBTA', 'args': {'pg': ['red/RDAV']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'RED', 'DAVIS']},
    {'service': 'MBTA', 'args': {'pg': ['red/RPOR']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'SQUARE', 'SQ', 'RED', 'PORTER']},
    {'service': 'MBTA', 'args': {'pg': ['red/RHAR']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'SQUARE', 'HARVARD', 'SQ', 'RED']},
    {'service': 'MBTA', 'args': {'pg': ['red/RCEN']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'SQUARE', 'SQ', 'RED', 'CENTRAL']},
    {'service': 'MBTA', 'args': {'pg': ['red/RKEN']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'RED', 'KENDALL', 'MIT']},
    {'service': 'MBTA', 'args': {'pg': ['red/RMGH']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'RED', 'MGH', 'CHARLES']},
    {'service': 'MBTA', 'args': {'pg': ['red/RPRK', 'green/pktrm']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'PARK', 'RED', 'ST', 'STREET', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['red/RDTC']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'CROSSING', 'DOWNTOWN', 'RED']},
    {'service': 'MBTA', 'args': {'pg': ['red/RSOU']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'STATION', 'RED', 'SOUTH']},
    {'service': 'MBTA', 'args': {'pg': ['red/RBRO']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'RED', 'BROADWAY']},
    {'service': 'MBTA', 'args': {'pg': ['red/RAND']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'RED', 'ANDREW']},
    {'service': 'MBTA', 'args': {'pg': ['red/RJFK']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'UMASS', 'JFK', 'RED']},
    {'service': 'MBTA', 'args': {'pg': ['red/RSAV']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'SAVIN', 'RED', 'HILL']},
    {'service': 'MBTA', 'args': {'pg': ['red/RFIE']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'CORNER', 'RED', 'FIELDS']},
    ...
    {'service': 'MBTA', 'args': {'pg': ['red/RNQU']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'QUINCY', 'RED', 'NORTH']},
    {'service': 'MBTA', 'args': {'pg': ['red/RWOL']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'RED', 'WOLLASTON']},
    {'service': 'MBTA', 'args': {'pg': ['red/RQUC']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'QUINCY', 'RED', 'CENTER']},
    {'service': 'MBTA', 'args': {'pg': ['red/RQUA']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'QUINCY', 'RED', 'ADAMS']},
    {'service': 'MBTA', 'args': {'pg': ['red/RBRA']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'RED', 'BRAINTREE']},
    {'service': 'MBTA', 'args': {'pg': ['orange/OOAK']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'OAK', 'ORANGE', 'GROVE']},
    {'service': 'MBTA', 'args': {'pg': ['orange/OMAL']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'MALDEN', 'CENTER', 'ORANGE']},
    {'service': 'MBTA', 'args': {'pg': ['orange/OWEL']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'WELLINGTON', 'ORANGE']},
    ...
    {'service': 'MBTA', 'args': {'pg': ['orange/OCOM']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'COMMUNITY', 'COLLEGE', 'ORANGE']},
    {'service': 'MBTA', 'args': {'pg': ['green/north', 'orange/ONST']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'STATION', 'NORTH', 'ORANGE', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/haecl', 'orange/OHAY']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'HAYMARKET', 'ORANGE', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['orange/OST']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'STATE', 'ST', 'STREET', 'ORANGE']},
    {'service': 'MBTA', 'args': {'pg': ['red/RDTC', 'orange/ODT']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'CROSSING', 'DOWNTOWN', 'RED', 'ORANGE']},
    {'service': 'MBTA', 'args': {'pg': ['orange/OCH']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'CHINATOWN', 'ORANGE']},
    {'service': 'MBTA', 'args': {'pg': ['orange/ONEM']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'TUFTS', 'MEDICAL', 'ORANGE']},
    {'service': 'MBTA', 'args': {'pg': ['orange/OBAC']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'BACK', 'BAY', 'ORANGE']},
    {'service': 'MBTA', 'args': {'pg': ['orange/OMAS']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'MASS', 'AVE', 'ORANGE']},
    {'service': 'MBTA', 'args': {'pg': ['orange/ORUG']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'RUGGLES', 'ORANGE']},
    {'service': 'MBTA', 'args': {'pg': ['orange/OROX']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'CROSSING', 'ROXBURY', 'ORANGE']},
    {'service': 'MBTA', 'args': {'pg': ['orange/OJAC']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'SQUARE', 'SQ', 'JACKSON', 'ORANGE']},
    {'service': 'MBTA', 'args': {'pg': ['orange/OSTO']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'STONY', 'BROOK', 'ORANGE']},
    {'service': 'MBTA', 'args': {'pg': ['orange/OGRE']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'ST', 'STREET', 'ORANGE', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['orange/OFOR']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'HILLS', 'ORANGE', 'FOREST']},
    {'service': 'MBTA', 'args': {'pg': ['blue/BWON']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'BLUE', 'WONDERLAND']},
    {'service': 'MBTA', 'args': {'pg': ['blue/BREV']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'REVERE', 'BLUE', 'BEACH']},
    {'service': 'MBTA', 'args': {'pg': ['blue/BBEA']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'BEACHMONT', 'BLUE']},
    {'service': 'MBTA', 'args': {'pg': ['blue/BSUF']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'DOWNS', 'SUFFOLK', 'BLUE']},
    {'service': 'MBTA', 'args': {'pg': ['blue/BORH']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'ORIENT', 'HEIGHTS', 'BLUE']},
    {'service': 'MBTA', 'args': {'pg': ['blue/BWOO']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'WOOD', 'BLUE', 'ISLAND']},
    {'service': 'MBTA', 'args': {'pg': ['blue/BAIR']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'AIRPORT', 'BLUE']},
    {'service': 'MBTA', 'args': {'pg': ['blue/BMAV']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'MAVERICK', 'BLUE']},
    {'service': 'MBTA', 'args': {'pg': ['blue/BAQU']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'AQUARIUM', 'BLUE']},
    {'service': 'MBTA', 'args': {'pg': ['blue/BSTA', 'orange/OST']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'STREET', 'STATE', 'ST', 'BLUE', 'ORANGE']},
    {'service': 'MBTA', 'args': {'pg': ['green/gover', 'blue/BGOV']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'CENTER', 'GOVERNMENT', 'BLUE', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['blue/BBOW']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'BOWDOIN', 'BLUE']},
    {'service': 'MBTA', 'args': {'pg': ['red/RPRK', 'green/pktrm']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'PARK', 'RED', 'ST', 'STREET', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['red/RDTC', 'orange/ODT']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'CROSSING', 'DOWNTOWN', 'RED', 'ORANGE']},
    {'service': 'MBTA', 'args': {'pg': ['green/haecl', 'orange/OHAY']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'HAYMARKET', 'ORANGE', 'GREEN']},
    {'service': 'MBTA', 'args': {'pg': ['green/north', 'orange/ONST']}, 'tags': ['MBTA', 'SUBWAY', 'T', 'SCHEDULE', 'LINE', 'STATION', 'NORTH', 'ORANGE', 'GREEN']},
