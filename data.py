...
box = [
    ...
    {'service': 'H', 'args':{ 'data_nid':"data-nid='1551'", 'label': "ANDOVER-HARVARD THEOLOGICAL LIBRARY"}, 'tags': ["ANDOVER", "-", "HARVARD", "THEOLOGICAL", "LIBRARY"]},
    {'service': 'H', 'args':{ 'data_nid':"data-nid='1600'", 'label': "ARNOLD ARBORETUM HORTICULTURAL LIBRARY"}, 'tags': ["ARNOLD", "ARBORETUM", "HORTICULTURAL", "LIBRARY"]},
    {'service': 'H', 'args':{ 'data_nid':"data-nid='1553'", 'label': "ARTHUR AND ELIZABETH SCHLESINGER LIBRARY"}, 'tags': ["ARTHUR", "AND", "ELIZABETH", "SCHLESINGER", "LIBRARY"]},
    {'service': 'H', 'args':{ 'data_nid':"data-nid='1558'", 'label': "BAKER LIBRARY"}, 'tags': ["BAKER", "LIBRARY"]},
    {'service': 'H', 'args':{ 'data_nid':"data-nid='1559'", 'label': "BAKER LIBRARY SPECIAL COLLECTIONS"}, 'tags': ["BAKER", "LIBRARY", "SPECIAL", "COLLECTIONS"]},
    {'service': 'H', 'args':{ 'data_nid':"data-nid='1603'", 'label': "BIBLIOTECA BERENSON"}, 'tags': ["BIBLIOTECA", "BERENSON"]},
    {'service': 'H', 'args':{ 'data_nid':"data-nid='1577'", 'label': "BIRKHOFF MATHEMATICAL LIBRARY"}, 'tags': ["BIRKHOFF", "MATHEMATICAL", "LIBRARY"]},
    {'service': 'H', 'args':{ 'data_nid':"data-nid='1724'", 'label': "BOTANY LIBRARY"}, 'tags': ["BOTANY", "LIBRARY"]},
    {'service': 'H', 'args':{ 'data_nid':"data-nid='1578'", 'label': "CABOT SCIENCE LIBRARY"}, 'tags': ["CABOT", "SCIENCE", "LIBRARY"]},
    {'service': 'H', 'args':{ 'data_nid':"data-nid='1580'", 'label': "CHEMISTRY AND CHEMICAL BIOLOGY LIBRARY"}, 'tags': ["CHEMISTRY", "AND", "CHEMICAL", "BIOLOGY", "LIBRARY"]},
    {'service': 'H', 'args':{ 'data_nid':"data-nid='2575'", 'label': "COUNTWAY LIBRARY OF MEDICINE"}, 'tags': ["COUNTWAY", "LIBRARY", "OF", "MEDICINE"]},
    {'service': 'H', 'args':{ 'data_nid':"data-nid='1618'", 'label': "DUMBARTON OAKS"}, 'tags': ["DUMBARTON", "OAKS"]},
    {'service': 'H', 'args':{ 'data_nid':"data-nid='1592'", 'label': "LOEB MUSIC LIBRARY"}, 'tags': ["LOEB", "MUSIC", "LIBRARY"]},
    {'service': 'H', 'args':{ 'data_nid':"data-nid='1539'", 'label': "ERNST MAYR LIBRARY"}, 'tags': ["ERNST", "MAYR", "LIBRARY"]},
    {'service': 'H', 'args':{ 'data_nid':"data-nid='1576'", 'label': "FINE ARTS LIBRARY"}, 'tags': ["FINE", "ARTS", "LIBRARY"]},
    {'service': 'H', 'args':{ 'data_nid':"data-nid='1581'", 'label': "FUNG LIBRARY"}, 'tags': ["FUNG", "LIBRARY"]},
    {'service': 'H', 'args':{ 'data_nid':"data-nid='1572'", 'label': "GOVERNMENT DOCUMENTS AND MICROFORMS COLLECTION"}, 'tags': ["GOVERNMENT", "DOCUMENTS", "AND", "MICROFORMS", "COLLECTION"]},
    {'service': 'H', 'args':{ 'data_nid':"data-nid='1536'", 'label': "GROSSMAN LIBRARY"}, 'tags': ["GROSSMAN", "LIBRARY"]},
    {'service': 'H', 'args':{ 'data_nid':"data-nid='1582'", 'label': "HARVARD FILM ARCHIVE"}, 'tags': ["HARVARD", "FILM", "ARCHIVE"]},
    {'service': 'H', 'args':{ 'data_nid':"data-nid='1535'", 'label': "HARVARD KENNEDY SCHOOL LIBRARY"}, 'tags': ["HARVARD", "KENNEDY", "SCHOOL", "LIBRARY"]},
    {'service': 'H', 'args':{ 'data_nid':"data-nid='1565'", 'label': "HARVARD LAW SCHOOL LIBRARY"}, 'tags': ["HARVARD", "LAW", "SCHOOL", "LIBRARY"]},
    {'service': 'H', 'args':{ 'data_nid':"data-nid='1583'", 'label': "HARVARD MAP COLLECTION"}, 'tags': ["HARVARD", "MAP", "COLLECTION"]},
    {'service': 'H', 'args':{ 'data_nid':"data-nid='3359'", 'label': "PUSEY LIBRARY"}, 'tags': ["PUSEY", "LIBRARY"]},
    {'service': 'H', 'args':{ 'data_nid':"data-nid='1591'", 'label': "HOUGHTON LIBRARY"}, 'tags': ["HOUGHTON", "LIBRARY"]},
    {'service': 'H', 'args':{ 'data_nid':"data-nid='1584'", 'label': "YENCHING LIBRARY"}, 'tags': ["YENCHING", "LIBRARY"]},
    {'service': 'H', 'args':{ 'data_nid':"data-nid='1571'", 'label': "LAMONT LIBRARY"}, 'tags': ["LAMONT", "LIBRARY"]},
    {'service': 'H', 'args':{ 'data_nid':"data-nid='1533'", 'label': "MONROE C. GUTMAN LIBRARY"}, 'tags': ["MONROE", "C.", "GUTMAN", "LIBRARY"]},
    {'service': 'H', 'args':{ 'data_nid':"data-nid='1595'", 'label': "PHYSICS RESEARCH LIBRARY"}, 'tags': ["PHYSICS", "RESEARCH", "LIBRARY"]},
    {'service': 'H', 'args':{ 'data_nid':"data-nid='4101'", 'label': "ROBBINS LIBRARY OF PHILOSOPHY"}, 'tags': ["ROBBINS", "LIBRARY", "OF", "PHILOSOPHY"]},
    {'service': 'H', 'args':{ 'data_nid':"data-nid='1596'", 'label': "TOZZER LIBRARY"}, 'tags': ["TOZZER", "LIBRARY"]},
    {'service': 'H', 'args':{ 'data_nid':"data-nid='1567'", 'label': "WIDENER LIBRARY"}, 'tags': ["HARRY", "ELKINS", "WIDENER", "LIBRARY"]},
    {'service': 'H', 'args':{ 'data_nid':"data-nid='1602'", 'label': "WOLBACH LIBRARY"}, 'tags': ["WOLBACH", "LIBRARY"]}
