...
box = [
    ...
    {'args': {'category': 'MAKE OR BUILD YOUR OWN', 'type': 'BREAKFAST'}, 'service': 'M', 'tags': ['MENU', 'BREAKFAST', 'MAKE OR BUILD YOUR OWN']},
    {'args': {'category': 'SPECIAL BARS - BOARD MENU', 'type': 'BREAKFAST'}, 'service': 'M', 'tags': ['MENU', 'BREAKFAST', 'SPECIAL BARS - BOARD MENU']},
    {'args': {'category': 'IN ADDITION AT ANNENBERG', 'type': 'BREAKFAST'}, 'service': 'M', 'tags': ['MENU', 'BREAKFAST', 'IN ADDITION AT ANNENBERG']},
    ...
    {'args': {'category': 'FROM THE GRILLE', 'type': 'LUNCH'}, 'service': 'M', 'tags': ['MENU', 'LUNCH', 'FROM THE GRILLE']},
    ...
    {'args': {'category': 'BREAD,ROLLS, MISC BAKERY', 'type': 'DINNER'}, 'service': 'M', 'tags': ['MENU', 'DINNER', 'BREAD,ROLLS, MISC BAKERY']},
    {'args': {'category': 'FROM THE GRILLE', 'type': 'DINNER'}, 'service': 'M', 'tags': ['MENU', 'DINNER', 'FROM THE GRILLE']},
