...
box = [
    ...
    {'service': 'F', 'args':{'user_input':'today'}, 'tags':['FOODTRUCKS','TODAY']},
    {'service': 'F', 'args':{'user_input':'tomorrow'}, 'tags':['FOODTRUCKS','TOMORROW']},
    {'service': 'F', 'args':{'user_input':'week'}, 'tags':['FOODTRUCKS','WEEK']}
]
