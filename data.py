...
box = [
    ...
    {'service': 'hours', 'args':{'BAK'}, 'tags':'BAKER'},
    {'service': 'hours', 'args':{'CAB'}, 'tags':'CABOT'},
    {'service': 'hours', 'args':{'FUNG'}, 'tags':'FUNG'},
    {'service': 'hours', 'args':{'GRO'}, 'tags':'GROSSMAN'},
    {'service': 'hours', 'args':{'KSG'}, 'tags':'KENNEDY'},
    {'service': 'hours', 'args':{'LAW'}, 'tags':'LAW'},
    {'service': 'hours', 'args':{'HYL'}, 'tags':'YENCHING'},
    {'service': 'hours', 'args':{'HOU'}, 'tags':'HOUGHTON'},
    {'service': 'hours', 'args':{'LAM'}, 'tags':'LAMONT'},
    {'service': 'hours', 'args':{'DES'}, 'tags':'LOEB'},
    {'service': 'hours', 'args':{'WID'}, 'tags':'WIDENER'},
    {'service': 'hours', 'args':{'Row-Column-8'}, 'tags':'ADAMS'},
    {'service': 'hours', 'args':{'Row-Column-9'}, 'tags':'ANNENBERG'},
    {'service': 'hours', 'args':{'Row-Column-10'}, 'tags':'CABOT'},
    {'service': 'hours', 'args':{'Row-Column-11'}, 'tags':'CURRIER'},
    {'service': 'hours', 'args':{'Row-Column-12'}, 'tags':'DUNSTER'},
    {'service': 'hours', 'args':{'Row-Column-13'}, 'tags':'ELIOT'},
    {'service': 'hours', 'args':{'Row-Column-14'}, 'tags':'HILLEL'},
    {'service': 'hours', 'args':{'Row-Column-13'}, 'tags':'KIRKLAND'},
    {'service': 'hours', 'args':{'Row-Column-15'}, 'tags':'LEVERETT'},
    {'service': 'hours', 'args':{'Row-Column-16'}, 'tags':'LOWELL'},
    {'service': 'hours', 'args':{'Row-Column-10'}, 'tags':'MATHER'},
    {'service': 'hours', 'args':{'Row-Column-17'}, 'tags':['PFOHO', 'PFORZHEIMER']},
    {'service': 'hours', 'args':{'Row-Column-18'}, 'tags':'QUINCY'},
    {'service': 'hours', 'args':{'Row-Column-19'}, 'tags':'WINTHROP'},
    {'service': 'hours', 'args':{'Row-Column-20'}, 'tags':['FLYBY', 'FLY', 'BY', 'FLY-BY']},
    {'service': 'hours', 'args':{'mac'}, 'tags':['HEMENWAY', 'MAC', 'MALKIN', 'MALKIN ATHLETIC CENTER', 'MAIL', 'MAIL CENTER', 'DORM CREW']},
    {'service': 'hours', 'args':{'views-row-1'}, 'tags':'BARKER'},
    {'service': 'hours', 'args':{'views-row-2'}, 'tags':'BAUER'},
    {'service': 'hours', 'args':{'views-row-3'}, 'tags':['QUEEN\'S', 'HEAD', 'CQH', 'CAMBRIDGE', 'PUB']},
    {'service': 'hours', 'args':{'views-row-4'}, 'tags':'CHAUHAUS'},
    {'service': 'hours', 'args':{'views-row-5'}, 'tags':'CGIS'},
    {'service': 'hours', 'args':{'views-row-6'}, 'tags':'CRONKHITE'},
    {'service': 'hours', 'args':{'views-row-7'}, 'tags':'DUDLEY'},
    {'service': 'hours', 'args':{'views-row-8'}, 'tags':['HKS', 'KENNEDY']},
    {'service': 'hours', 'args':{'views-row-9'}, 'tags':['HLS', 'PUB']},
    {'service': 'hours', 'args':{'views-row-10'}, 'tags':['LAMONT', 'CAFE']},
    {'service': 'hours', 'args':{'views-row-11'}, 'tags':'LISE'},
    {'service': 'hours', 'args':{'views-row-12'}, 'tags':'NORTHWEST'},
    {'service': 'hours', 'args':{'views-row-13'}, 'tags':'OBSERVATORY'},
    {'service': 'hours', 'args':{'views-row-14'}, 'tags':['SEBASTIAN\'S', 'SEBASTIANS']}
