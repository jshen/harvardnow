...
box = [
    ...
    {'service': 'B', 'args':{'team': 'GSW'}, 'tags': ['GSW','WARRIORS']},
    {'service': 'B', 'args':{'team': 'SAS'}, 'tags': ['SAS','SPURS']},
    {'service': 'B', 'args':{'team': 'OKC'}, 'tags': ['OKC','THUNDER']},
    {'service': 'B', 'args':{'team': 'LAC'}, 'tags': ['LAC','CLIPPERS']},
    {'service': 'B', 'args':{'team': 'POR'}, 'tags': ['POR','TRAIL BLAZERS']},
    {'service': 'B', 'args':{'team': 'DAL'}, 'tags': ['DAL','MAVERICKS']},
    {'service': 'B', 'args':{'team': 'MEM'}, 'tags': ['MEM','GRIZZLIES']},
    {'service': 'B', 'args':{'team': 'HOU'}, 'tags': ['HOU','ROCKETS']},
    {'service': 'B', 'args':{'team': 'UTA'}, 'tags': ['UTA','JAZZ']},
    {'service': 'B', 'args':{'team': 'SAC'}, 'tags': ['SAC','KINGS']},
    {'service': 'B', 'args':{'team': 'DEN'}, 'tags': ['DEN','NUGGETS']},
    {'service': 'B', 'args':{'team': 'NOP'}, 'tags': ['NOP','PELICANS']},
    {'service': 'B', 'args':{'team': 'MIN'}, 'tags': ['MIN','TIMBERWOLVES']},
    {'service': 'B', 'args':{'team': 'PHO'}, 'tags': ['PHO','SUNS']},
    {'service': 'B', 'args':{'team': 'LAL'}, 'tags': ['LAL','LAKERS']},
    {'service': 'B', 'args':{'team': 'CLE'}, 'tags': ['CLE','CAVALIERS']},
    {'service': 'B', 'args':{'team': 'TOR'}, 'tags': ['TOR','RAPTORS']},
    {'service': 'B', 'args':{'team': 'MIA'}, 'tags': ['MIA','HEAT']},
    {'service': 'B', 'args':{'team': 'ATL'}, 'tags': ['ATL','HAWKS']},
    {'service': 'B', 'args':{'team': 'BOS'}, 'tags': ['BOS','CELTICS']},
    {'service': 'B', 'args':{'team': 'CHO'}, 'tags': ['CHO','HORNETS']},
    {'service': 'B', 'args':{'team': 'IND'}, 'tags': ['IND','PACERS']},
    {'service': 'B', 'args':{'team': 'DET'}, 'tags': ['DET','PISTONS']},
    {'service': 'B', 'args':{'team': 'CHI'}, 'tags': ['CHI','BULLS']},
    {'service': 'B', 'args':{'team': 'WAS'}, 'tags': ['WAS','WIZARDS']},
    {'service': 'B', 'args':{'team': 'ORL'}, 'tags': ['ORL','MAGIC']},
    {'service': 'B', 'args':{'team': 'MIL'}, 'tags': ['MIL','BUCKS']},
    {'service': 'B', 'args':{'team': 'NYK'}, 'tags': ['NYK','KNICKS']},
    {'service': 'B', 'args':{'team': 'BKN'}, 'tags': ['BKN','NETS']},
    {'service': 'B', 'args':{'team': 'PHI'}, 'tags': ['PHI','76ERS']},
