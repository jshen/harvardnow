...
def eval(cmd, input=None):
    ...
    if cmd['service'] == 'L': ## Laundry
        ...
        return library_hours.eval(input)
    else:
...
def special(incoming):
    ...
    if incoming.upper() == "SHUTTLE" :
    ...
    elif incoming.upper() == "LIBRARY HOURS":
        body = library_hours.special
        ...
        body += 'To access library hours send the name of the library\n'
        body += 'e.g. library hours Widener Library\n'
    return body
