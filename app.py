...
def eval(cmd, input=None):
    ...
    elif cmd['service'] == 'V': ## (Varsity) Sports
...
def special(incoming):
    ...
    if incoming.upper() == "SHUTTLE" :
        ...
        body += 'To access info about varsity sports on a certain date, send "sports <month>/<day>/<year>".\n'
    return body
